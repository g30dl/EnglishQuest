...
class CurrentUserService {
  // Determina el rol usando metadatos del usuario, con fallback a student.
  deriveRole(user) {
    return (
  ...
  // Recupera la sesion actual desde Supabase.
  async getSession() {
  ...
  async getProfile(userId) {
    ...
    try {
      // Busca el registro en tabla users; puede fallar por RLS.
  ...
  // Actualiza la racha diaria y devuelve el valor resultante.
